            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is the list of your search</p>
                </div>
                <div class="card-body">
...
$con=mysqli_connect("localhost", "root", "","unitenclub") or die("Cannot connect to server.".mysqli_error($con));
 ...
 $sql="SELECT * FROM usertb WHERE NOT username ='admin' AND username LIKE '%$search%' OR name LIKE '%$search%' OR address LIKE '%$search%' OR phone LIKE '%$search%' OR college LIKE '%$search%' OR gender LIKE '%$search%' OR gender LIKE '%$search%'";
