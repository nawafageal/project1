...
$con = mysqli_connect("localhost", "root", "", "unitenclub");
    ...
    $id=$_GET['chk'];
$ret = "SELECT * FROM usertb WHERE email='".$id."'";
        ...
        <section style="padding-bottom: 50px; padding-top: 50px;">
            <div class="row">
                <div class="alert alert-info">
                        ...
                        <p>
                           Welcome to <?php echo $row[1];?> profile, you can edit the details here...
                        </p>
                    </div>
                ...
                <div class="col-md-8">
                    ...
                    <div>
                        <a href="#" class="btn btn-social btn-facebook">
                            <i class="fa fa-user"></i>&nbsp; ALREADY REGISTERED FOR THE EVENT</a>
                    ...
                    <input type="text" name="username" class="form-control" value="<?php echo $row[0];?>" >
                  ...
                  <br>  <label>Registered Email</label>
                    <input type="text" name="email" disabled class="form-control" value="<?php echo $row[2];?>"><br>
 <input type="hidden" name="email1"  class="form-control" value="<?php echo $row[2];?>"><br>
